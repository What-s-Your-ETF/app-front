        ...
        <Col md="12">
          <Card>
            <CardHeader>
              ...
              <FormControl style={{fontSize:'25px'}} value={boardTitle} onChange={(e)=>setBoardTitle(e.target.value)}></FormControl>
            </CardHeader>
            <CardBody>
              ...
              {/* <input type='text' value={boardContent} onChange={(e)=>setBoardContent(e.target.value)}/> */}
                ...
                <textarea className="form-control" rows={3} value={boardContent} onChange={(e)=>setBoardContent(e.target.value)}></textarea>
